...
export const AdminPackage = ({ pack = [], generatePDF, Entregar, formatDate, eliminarPaquete, reenviarMensaje }) => {
    ...
    return (
        ...
        <>
            ...
            <td><button type="button" className="btn btn-primary" onClick={() => reenviarMensaje(pack)}>Reenviar Mensaje</button></td>
